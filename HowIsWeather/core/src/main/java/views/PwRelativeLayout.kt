...
class PwRelativeLayout:RelativeLayout {
    ...
    fun showMessageWithImage(drawableId:Int=R.drawable.icon_no_connection,title:String,message: String,retryButton:Boolean=false){
        // show main layout
        show()
    ...
    fun showMessageWithoutImage(title:String,message: String,retryButton:Boolean=false,onRetryClick:OnClickListener){
        // show main layout
        show()
